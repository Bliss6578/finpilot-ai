...
export default function Intelligence() {
  ...
  return <>
    ...
    {error && <div className="api-error"><strong>Intelligence unavailable</strong><span>Paymentor could not calculate every workspace signal.</span></div>}
