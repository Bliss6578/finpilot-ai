  ...
  return (
    <div className="public-site">
      ...
      <footer className="public-footer">
        <div>
          <Link href="/" className="public-logo"><span><Sparkles /></span>Paymentor</Link>
        ...
        <small>© 2026 Paymentor AI · Private beta</small>
      </footer>
    </div>
  );
}
...
export function AboutPage() {
  return (
    <PublicShell index="01" eyebrow="ABOUT" title="A clearer financial operating picture." intro="Paymentor is a private-beta finance intelligence workspace being built for businesses that use Razorpay.">
      ...
      <PolicySection title="What Paymentor is">
        <p>Paymentor is software for financial visibility and operational decision support. It is not a bank, payment aggregator, lender, accounting firm, or investment adviser. Razorpay remains the payment service provider for connected merchants.</p>
      </PolicySection>
...
export function ContactPage() {
  return (
    <PublicShell index="02" eyebrow="CONTACT" title="Talk to the Paymentor team." intro="Questions about beta access, privacy, security, or your connected Razorpay data can be sent to one place.">
      <div className="contact-card">
        <div className="contact-icon"><Mail /></div>
        <div><span>GENERAL, SUPPORT & PRIVACY</span><h2>{contactEmail}</h2><p>Include your Paymentor account email and a short description. Never send passwords, OTPs, Razorpay key secrets, or full card details.</p></div>
...
export function PricingPage() {
  return (
    <PublicShell index="03" eyebrow="PRICING" title="Private beta. No subscription charge." intro="Paymentor is not currently collecting subscription payments. Approved beta users can test the workspace at ₹0.">
      ...
      <PolicySection title="Before paid plans begin">
        <p>Any future paid plan, taxes, billing frequency, renewal terms, and cancellation conditions will be displayed clearly before a user is asked to pay. Paymentor will not convert a beta account into a paid subscription without the account owner’s express confirmation.</p>
      </PolicySection>
      <PolicySection title="Razorpay charges">
        <p>Fees charged by Razorpay for a merchant’s own payment services are separate from Paymentor and are governed by the merchant’s agreement with Razorpay.</p>
      </PolicySection>
    </PublicShell>
  );
}
...
export function PrivacyPolicyPage() {
  return (
    <PublicShell index="04" eyebrow="PRIVACY POLICY" title="Your business data stays in context." intro="This policy explains what Paymentor collects, why it is used, and the choices available to account owners.">
      <Updated />
      <PolicySection title="1. Scope"><p>This policy applies to the Paymentor website, accounts, dashboard, and private-beta services. “Paymentor”, “we”, and “us” refer to the operator of this service.</p></PolicySection>
      ...
      <PolicySection title="4. Razorpay connection"><p>Paymentor should request only the permissions required for the connected features. Razorpay credentials and tokens must be handled server-side. Users can disconnect Razorpay from Paymentor settings or through their Razorpay account, subject to available integration controls.</p></PolicySection>
      ...
      <PolicySection title="8. Children and changes"><p>Paymentor is a business service and is not intended for children. We may update this policy as the product changes; the updated date will appear above and material changes will be communicated where required.</p></PolicySection>
...
export function TermsPage() {
  return (
    <PublicShell index="05" eyebrow="TERMS & CONDITIONS" title="Terms for using Paymentor." intro="These terms set the rules for private-beta access and use of the Paymentor service.">
      <Updated />
      ...
      <PolicySection title="3. Razorpay and third-party services"><p>Connecting Razorpay authorises Paymentor to access data within the permissions shown during connection. Razorpay is a separate service with its own terms and privacy practices. Paymentor is not responsible for Razorpay availability, payment processing, settlements, disputes, or fees.</p></PolicySection>
      <PolicySection title="4. Financial information disclaimer"><p>Paymentor provides software-generated information and decision support. Outputs may be incomplete, delayed, experimental, or incorrect and are not financial, investment, accounting, tax, or legal advice. You remain responsible for verifying data and business decisions with qualified professionals where appropriate.</p></PolicySection>
      <PolicySection title="5. Acceptable use"><p>You must not misuse the service, violate law, upload malicious code, probe or bypass security, interfere with other users, reverse engineer restricted portions, access data without authority, or use Paymentor to facilitate fraud or prohibited activity.</p></PolicySection>
      ...
      <PolicySection title="7. Intellectual property"><p>Paymentor and its original software, interface, branding, and content are owned by or licensed to the service operator. You retain rights in your business data and grant us the limited permission needed to process it to provide and improve the service.</p></PolicySection>
      <PolicySection title="8. Liability"><p>To the maximum extent permitted by law, the beta service is provided without warranties of uninterrupted operation or fitness for a particular purpose. Paymentor is not liable for decisions made solely from automated outputs, indirect losses, or failures of third-party services. Nothing here excludes rights or liabilities that cannot legally be excluded.</p></PolicySection>
...
export function RefundPolicyPage() {
  return (
    <PublicShell index="06" eyebrow="CANCELLATION & REFUND" title="A simple policy for the beta period." intro="Paymentor currently charges ₹0 for approved private-beta access, so there is no Paymentor subscription payment to cancel or refund.">
      <Updated />
      ...
      <PolicySection title="Cancel beta access"><p>You may stop using Paymentor at any time. You can disconnect Razorpay and request account closure by contacting support. Access may remain available until the closure request is completed.</p></PolicySection>
      <PolicySection title="Future paid services"><p>Before paid subscriptions are offered, Paymentor will publish the price, billing frequency, renewal, cancellation deadline, refund eligibility, and processing timeline. Users will be asked to accept those terms before any charge is made.</p></PolicySection>
      <PolicySection title="Razorpay merchant fees"><p>This policy covers charges made by Paymentor only. It does not cover payment processing fees, reversals, disputes, or other amounts charged by Razorpay under a merchant’s separate Razorpay agreement.</p></PolicySection>
...
export function DeliveryPolicyPage() {
  return (
    <PublicShell index="07" eyebrow="DIGITAL DELIVERY" title="Delivered online. Nothing is shipped." intro="Paymentor is a software service. Access and product features are delivered electronically through a secured web account.">
      <Updated />
      <div className="public-feature-grid compact">
        <section><Mail /><h2>Account access</h2><p>After registration is accepted, users receive access through the Paymentor sign-in page.</p></section>
        ...
        <section><ShieldCheck /><h2>No physical shipping</h2><p>Paymentor does not sell or ship physical goods. Shipping charges and tracking do not apply.</p></section>
      </div>
      ...
      <PolicySection title="Changes during beta"><p>Features, access limits, and availability may change while Paymentor is in private beta. Material changes affecting a user’s access will be communicated where practical.</p></PolicySection>
    </PublicShell>
  );
}
